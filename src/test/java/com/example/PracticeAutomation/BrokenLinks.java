...
public class BrokenLinks {
  ...
  public void testBrokenLinks() throws Exception {
	    ...
	    try {
	    	// Broken Links :  Titre de la page Global
	    
	    WebElement element = driver.findElement(By.xpath("//div[@id='top-wrap']/section/div/h1"));
	    
	    String itemPromp = element.getAttribute("itempromp");
	    
	    System.out.println("itemPromp ==> "+ itemPromp);
	    
	    // Point Verification : Resultat Attendus
	    ...
	    element = driver.findElement(By.xpath("//article[@id='post-1267']/div/p[3]"));
          ...
          element = driver.findElement(By.xpath("//article[@id='post-1267']/div/figure/table/thead/tr/th[2]"));
